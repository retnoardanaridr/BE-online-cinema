...
import (
	...
	transactiondto "BE-waysbuck-API/dto/transaction"
...
func (h *handlerTransaction) FindTransactions(w http.ResponseWriter, r *http.Request) {
	...
	transactions, err := h.TransactionRepository.FindTransactions() //bag repo
	if err != nil {
...
func (h *handlerTransaction) GetTransUser(w http.ResponseWriter, r *http.Request) {
	...
	transactionUserID, err := h.TransactionRepository.GetTransactionByUser(id)
	if err != nil {
	...
	w.WriteHeader(http.StatusOK)
	response := dto.SuccessResult{Status: "Success", Data: transactionUserID}
	json.NewEncoder(w).Encode(response)
}
...
func (h *handlerTransaction) CreateTransaction(w http.ResponseWriter, r *http.Request) {
	...
	dataTransaction := models.Transaction{
		ID:     idTrans,
		UserID: id,
		FilmID: request.FilmID, // baru tak tambah
		Price:  request.Price,
		Status: "waiting",
	}

	newTransaction, err := h.TransactionRepository.CreateTransaction(dataTransaction)
	if err != nil {
		w.WriteHeader(http.StatusInternalServerError)
...
func SendMail(status string, transaction models.Transaction) {
	...
	if status != transaction.Status && (status == "success") {
		...
		var CONFIG_SENDER_NAME = "WaysBucks <retnoardanari1728@gmail.com>"
